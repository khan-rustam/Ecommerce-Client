  ...
  return (
    <div className="min-h-screen py-10 px-2 md:px-8 flex flex-col items-center" style={{ background: 'var(--brand-bg)' }}>
      <div className="w-full max-w-6xl bg-white rounded-2xl shadow-xl p-8 animate-fade-in">
        <h1 className="text-2xl font-bold mb-6" style={{ color: 'var(--brand-primary)' }}>Cancelled Orders</h1>
                ...
                <tr>
                  <td colSpan={7} className="py-16 text-center text-gray-400">
                    <div className="flex flex-col items-center gap-4">
                      ...
                      <div className="text-xl font-semibold text-gray-500">No Cancelled Orders Yet</div>
                      <div className="text-gray-400 mb-4">No cancelled orders have been placed yet.</div>
                    </div>
                  </td>
                </tr>
              ) : (
