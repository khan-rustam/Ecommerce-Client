...
import { Image as ImageIcon, UploadCloud, X, Plus, Tag, Loader2, ArrowLeft } from 'lucide-react';
...
const CreateBlog: React.FC<{}> = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate(isPublished ? '/blogs' : '/admin/blogs');
    } catch (error) {
    ...
    <div className="max-w-5xl mx-auto p-6 md:p-10">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm p-6 md:p-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-xs text-gray-500">
            {isPublished 
              ? 'Your blog will be visible to all users once created'
