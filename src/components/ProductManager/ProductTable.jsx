...
const ProductTable = ({
  ...
  const getSortIcon = (field) => {
    ...
    return sort.order === 'asc' ? <FaChevronUp className="ml-1" /> : <FaChevronDown className="ml-1" />;
  };
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {products.map((product) => (
                  <tr key={product._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{product.stock || product.stockQuantity || 0}</div>
                    ...
                    <td className="px-4 py-4 whitespace-nowrap">
                      ...
                      >
                        {product.status || (product.isHidden ? 'Hidden' : 'Published')}
                      </span>
                    </td>
